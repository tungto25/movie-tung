...
function TvSerie(props) {
    ...
    // Phân trang
    const moviesPhimbo = filteredMovies.filter(f => f.movieType === "phim bộ");
    const paginatedData = moviesPhimbo.slice((page - 1) * rowsPerPage, page * rowsPerPage);
    const totalPages = Math.ceil(moviesPhimbo.length / rowsPerPage);
