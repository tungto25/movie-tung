    ...
    return (
        <div className="space-y-10 p-6 text-white m-auto mt-5 rounded-2xl">
            <div className="flex gap-4 items-center">
                <h1 className="font-bold text-base text-xl lg:text-2xl">Phim Lẻ Hot Nhất Hôm Nay</h1>
                            ...
                            >
                                ...
                                >
                                    <img
                                        src={e.img}
                                        alt={e.name}
                                        className={`rounded-xl hover:scale-102 h-[250px] md:h-[370px] lg:h-[330px] ${idx % 2 === 0 ? "-skew-y-5" : "skew-y-5"}`}
                                    />
