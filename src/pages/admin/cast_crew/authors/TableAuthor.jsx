...
function TableAuthor({ editOpen, setIdDeleted, setOpenDeleted, search, page, setPage }) {
    ...
    const dataSearch = useSearch(authors, search, (e) => e.name);
    ...
    const handleDeleteAll = async () => {
        ...
        try {
            await Promise.all(selectedIds.map(id => deleteDocument("Authors", id)));
            setSelectedIds([]);
