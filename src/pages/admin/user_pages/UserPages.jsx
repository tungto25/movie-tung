...
function UserPages(props) {
            ...
            await Promise.all(
                validRows.map(async (row) => {
                    await addDocument("Accounts", {
                        ...
                        imgUrl: row.imgUrl ? row.imgUrl.trim() : "",
                    });
                })
            );
    ...
    return (
        <div>
            <div>
                <SearchAdmin openExcel={openExcel} setOpenExcel={setOpenExcel} addToExcel={addToExcel} handleFileUpload={handleFileUpload} title="Accounts" buttonText="ACCOUNT" handleOpen={handleOpen} search={search} setSearch={setSearch} handleSearch={handleSearch} />
                <TableUser editOpen={editOpen} setOpenDeleted={setOpenDeleted} setIdDeleted={setIdDeleted} page={page} setPage={setPage} search={search} />
                <ModalUser inner={inner} handleUpdate={handleUpdate} open={open} handleClose={handleClose} account={account} setAccount={setAccount} error={error} setError={setError} />
