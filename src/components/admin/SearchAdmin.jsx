...
function SearchAdmin({ handleOpen, search, handleSearch, setSearch }) {
    ...
    return (
        <div className="flex justify-between items-center mt-5 p-5 flex-col md:flex-row gap-3">
            <h1 className="text-xl font-bold text-shadow-md">List Categories</h1>
            ...
            <button onClick={handleOpen} className="rounded-lg shadow-md py-3 px-4 bg-blue-500 hover:bg-blue-600">ADD CATEGORY</button>
        </div>
    );
}
